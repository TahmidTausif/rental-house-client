...
const PropertyCard: React.FC<PropertyCardProps> = ({
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col h-full">
      <div className="relative w-full aspect-[16/9] overflow-hidden rounded-t-lg shrink-0">
        {/* Image Carousel */}
        <Image
        ...
        {/* Badge */}
        <span className="absolute top-2 left-2 bg-secondary text-white text-sm font-semibold rounded-md px-4 py-2 z-10">
        ৳{price}/month
        </span>
